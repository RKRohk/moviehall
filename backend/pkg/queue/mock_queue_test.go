...
// Source: github.com/rkrohk/moviehall/pkg/queue (interfaces: Publisher)

// Package queue_test is a generated GoMock package.
package queue_test
...
func (m *MockPublisher) Publish(arg0 interface{}) error {
	m.ctrl.T.Helper()
